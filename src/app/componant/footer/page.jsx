...
const Footer = () => {
  ...
  const techStack = [
    'Microsoft Sentinel', 'Defender XDR', 'IBM QRadar', 'Splunk', 'ELK Stack', 'SOAR', 'CTI', 'DFIR', 'KQL'
  ];
            ...
            <div className="lg:col-span-2">
              <div className="mb-8">
                ...
                <p className="text-gray-300 text-lg leading-relaxed max-w-md">
                  <span className="font-bold text-white">SOC Analyst</span> focused on continuous monitoring, incident response, and proactive threat hunting.<br />
                  Skilled at SIEM/XDR operations, CTI enrichment, and securing hybrid identity and infrastructure.
                </p>
              </div>
            ...
            <div className={`transition-all duration-1000 ${
              ...
              <div className="space-y-4">
                <div className="flex items-center space-x-3 text-gray-300">
                  ...
                  <span>ahmedhasssann2003@gmail.com</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-300">
                  <span className="text-lg">📱</span>
                  <span>01277251911</span>
                </div>
                <div className="flex items-center space-x-3 text-gray-300">
                  <span className="text-lg">🌍</span>
                ...
                <div className="flex items-center space-x-3 text-gray-300">
                  <span className="text-lg">💼</span>
                  <span>Open to SOC analyst opportunities</span>
                </div>
              </div>
            ...
            <div className={`flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0 transition-all duration-1000 ${
              ...
              <div className="flex flex-col md:flex-row items-center space-y-2 md:space-y-0 md:space-x-6">
                <p className="text-gray-400 text-center md:text-left">
                  © {currentYear} Ahmed Mohamed Hassan. All rights reserved.
                </p>
