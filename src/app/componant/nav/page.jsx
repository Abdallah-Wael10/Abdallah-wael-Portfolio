                ...
                <div className="flex items-center space-x-4 mr-3">
                  ...
                  >
                    <div className="relative w-12 h-12 lg:w-14 lg:h-14">
                      <Image
                        src={MyImage}
                        alt="Ahmed Mohamed Hassan - SOC Analyst"
                        fill
            ...
            <div className="text-center mb-8 pb-6 border-b border-gray-200/60">
              <div className="flex items-center justify-center space-x-4 mb-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-medium">SOC Analyst</p>
                </div>
              </div>
              <div className="flex items-center justify-center space-x-2">
                <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse"></div>
                <span className="text-sm text-gray-500 font-medium">Available for SOC roles</span>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex justify-center space-x-4">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-14 h-14 bg-emerald-100 rounded-2xl flex items-center justify-center text-emerald-600 hover:bg-emerald-600 hover:text-white transition-all duration-300 hover:scale-110 hover:shadow-lg"
                >
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 4h16v16H4z" />
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 16h8M8 12h8M8 8h5" />
                  </svg>
                </a>
            ...
            <div className="relative z-10 p-6 sm:p-8 text-center">
              ...
              <div className="mb-6">
                ...
                <p className="text-gray-600 leading-relaxed text-sm sm:text-base">
                  Dedicated SOC Analyst focused on security monitoring, incident response, and proactive threat hunting across hybrid environments.
                </p>
              </div>
              ...
              <div className="w-full gap-3 flex justify-center items-center mb-6 flex-wrap">
                <div className="w-[40%] bg-white/60 rounded-2xl p-3 border border-white/40">
                  <div className="text-xl font-bold text-blue-600">2022-2026</div>
                  <div className="text-xs text-gray-600">Info Systems</div>
                </div>
                <div className="w-[40%] bg-white/60 rounded-2xl p-3 border border-white/40">
                  <div className="text-xl font-bold text-purple-600">SOC</div>
                  <div className="text-xs text-gray-600">Hybrid Security</div>
                </div>
              </div>
